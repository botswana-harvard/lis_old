...
#
from astm_classes.mapping import ComponentField
...
from .mapping import (
    ...
    TextField, RepeatedComponentField, Component, DecimalField
...
PatientRecord = Record.build(
    ...
    TextField(name='practice_id', required=True),
    ...
    DateTimeField(name='admission_date'),
...
ResultRecord = Record.build(
    ...
    DateTimeField(name='completed_at'),
