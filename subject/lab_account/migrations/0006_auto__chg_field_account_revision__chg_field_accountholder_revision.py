...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Account.revision'
        db.alter_column('bhp_lab_registration_account', 'revision', self.gf('django.db.models.fields.CharField')(max_length=150, null=True))

        # Changing field 'AccountHolder.revision'
        db.alter_column('bhp_lab_registration_accountholder', 'revision', self.gf('django.db.models.fields.CharField')(max_length=150, null=True))

    def backwards(self, orm):

        # Changing field 'Account.revision'
        db.alter_column('bhp_lab_registration_account', 'revision', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'AccountHolder.revision'
        db.alter_column('bhp_lab_registration_accountholder', 'revision', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))
