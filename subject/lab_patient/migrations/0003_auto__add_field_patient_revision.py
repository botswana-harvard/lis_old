...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Patient.revision'
        db.add_column('bhp_lab_registration_patient', 'revision',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Patient.revision'
        db.delete_column('bhp_lab_registration_patient', 'revision')
