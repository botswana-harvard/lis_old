...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        m2m_table_name = db.shorten_name('bhp_lab_registration_patient_account')
        ...
        db.create_unique(m2m_table_name, ['patient_id', 'account_id'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table(db.shorten_name('bhp_lab_registration_patient_account'))
