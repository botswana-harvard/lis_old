...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Patient.revision'
        db.alter_column('bhp_lab_registration_patient', 'revision', self.gf('django.db.models.fields.CharField')(max_length=150, null=True))

    def backwards(self, orm):

        # Changing field 'Patient.revision'
        db.alter_column('bhp_lab_registration_patient', 'revision', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))
