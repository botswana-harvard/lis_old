...
#     from edc.lab.lab_panel.models import Panel, PanelGroup, TidPanelMapping
#     from edc.lab.lab_test_code.models import TestCode, TestCodeGroup, TestCodeReferenceList, TestCodeReferenceListItem
