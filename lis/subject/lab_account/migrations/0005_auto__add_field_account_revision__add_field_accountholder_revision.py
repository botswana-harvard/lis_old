...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Account.revision'
        db.add_column('bhp_lab_registration_account', 'revision',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Adding field 'AccountHolder.revision'
        db.add_column('bhp_lab_registration_accountholder', 'revision',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Account.revision'
        db.delete_column('bhp_lab_registration_account', 'revision')

        # Deleting field 'AccountHolder.revision'
        db.delete_column('bhp_lab_registration_accountholder', 'revision')
