...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Aliquot.revision'
        db.alter_column('bhp_lab_core_aliquot', 'revision', self.gf('django.db.models.fields.CharField')(max_length=150, null=True))

    def backwards(self, orm):

        # Changing field 'Aliquot.revision'
        db.alter_column('bhp_lab_core_aliquot', 'revision', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))
