...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Receive.revision'
        db.alter_column('bhp_lab_core_receive', 'revision', self.gf('django.db.models.fields.CharField')(max_length=150, null=True))

        # Changing field 'ReceiveIdentifier.revision'
        db.alter_column(u'lab_receive_receiveidentifier', 'revision', self.gf('django.db.models.fields.CharField')(max_length=150, null=True))

    def backwards(self, orm):

        # Changing field 'Receive.revision'
        db.alter_column('bhp_lab_core_receive', 'revision', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'ReceiveIdentifier.revision'
        db.alter_column(u'lab_receive_receiveidentifier', 'revision', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))
    ...
    models = {
        ...
        'lab_receive.receive': {
            ...
            'receive_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 1, 9, 0, 0)', 'db_index': 'True'}),
        ...
        'lab_receive.receiveidentifier': {
            'Meta': {'object_name': 'ReceiveIdentifier'},
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
