...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('bhp_lab_core_receive', 'revision',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Adding field 'ReceiveIdentifier.revision'
        db.add_column(u'lab_receive_receiveidentifier', 'revision',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Receive.revision'
        db.delete_column('bhp_lab_core_receive', 'revision')

        # Deleting field 'ReceiveIdentifier.revision'
        db.delete_column(u'lab_receive_receiveidentifier', 'revision')
