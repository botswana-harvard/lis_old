...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ResultItem.revision'
        db.alter_column('bhp_lab_core_resultitem', 'revision', self.gf('django.db.models.fields.CharField')(max_length=150, null=True))

    def backwards(self, orm):

        # Changing field 'ResultItem.revision'
        db.alter_column('bhp_lab_core_resultitem', 'revision', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))
