...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'lab_grading_gradinglistitem', 'hostname_created',
        ...
        db.add_column(u'lab_grading_gradinglistitem', 'hostname_modified',
                      self.gf('django.db.models.fields.CharField')(default='mac.local', max_length=50, blank=True, db_index=True),
                      keep_default=False)

        # Adding field 'GradingListItem.created'
        db.add_column(u'lab_grading_gradinglistitem', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True),
                      keep_default=False)

        # Adding field 'GradingListItem.user_modified'
        db.add_column(u'lab_grading_gradinglistitem', 'user_modified',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True),
                      keep_default=False)

        # Adding field 'GradingListItem.modified'
        db.add_column(u'lab_grading_gradinglistitem', 'modified',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True),
                      keep_default=False)

        # Adding field 'GradingListItem.user_created'
        db.add_column(u'lab_grading_gradinglistitem', 'user_created',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True),
                      keep_default=False)

        # Adding field 'GradingList.hostname_created'
        db.add_column(u'lab_grading_gradinglist', 'hostname_created',
                      self.gf('django.db.models.fields.CharField')(default='mac.local', max_length=50, blank=True, db_index=True),
                      keep_default=False)

        # Adding field 'GradingList.hostname_modified'
        db.add_column(u'lab_grading_gradinglist', 'hostname_modified',
                      self.gf('django.db.models.fields.CharField')(default='mac.local', max_length=50, blank=True, db_index=True),
                      keep_default=False)

        # Adding field 'GradingList.user_created'
        db.add_column(u'lab_grading_gradinglist', 'user_created',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True),
                      keep_default=False)

        # Adding field 'GradingList.created'
        db.add_column(u'lab_grading_gradinglist', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True),
                      keep_default=False)

        # Adding field 'GradingList.user_modified'
        db.add_column(u'lab_grading_gradinglist', 'user_modified',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True),
                      keep_default=False)

        # Adding field 'GradingList.modified'
        db.add_column(u'lab_grading_gradinglist', 'modified',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True),
                      keep_default=False)
