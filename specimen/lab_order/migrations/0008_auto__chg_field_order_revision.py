...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('bhp_lab_core_order', 'revision', self.gf('django.db.models.fields.CharField')(max_length=150, null=True))

    def backwards(self, orm):

        # Changing field 'Order.revision'
        db.alter_column('bhp_lab_core_order', 'revision', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))
