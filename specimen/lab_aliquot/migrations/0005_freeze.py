...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        'lab_aliquot.aliquot': {
            ...
            'aliquot_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 9, 30, 0, 0)'}),
        ...
        'lab_receive.receive': {
            ...
            'receive_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 9, 30, 0, 0)', 'db_index': 'True'}),
    ...
    complete_apps = ['lab_aliquot', 'lab_aliquot']