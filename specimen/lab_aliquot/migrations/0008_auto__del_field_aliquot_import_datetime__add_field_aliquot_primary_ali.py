...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Aliquot.import_datetime'
        db.delete_column('bhp_lab_core_aliquot', 'import_datetime')

        # Adding field 'Aliquot.primary_aliquot'
        db.add_column('bhp_lab_core_aliquot', 'primary_aliquot',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='primary', null=True, to=orm['lab_aliquot.Aliquot']),
                      keep_default=False)

        # Adding field 'Aliquot.source_aliquot'
        db.add_column('bhp_lab_core_aliquot', 'source_aliquot',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='source', null=True, to=orm['lab_aliquot.Aliquot']),
                      keep_default=False)

        # Adding field 'Aliquot.is_packed'
        db.add_column('bhp_lab_core_aliquot', 'is_packed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Removing index on 'Aliquot', fields ['receive_identifier']
        db.delete_index('bhp_lab_core_aliquot', ['receive_identifier'])


        # Changing field 'Aliquot.subject_identifier'
        db.alter_column('bhp_lab_core_aliquot', 'subject_identifier', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))
        # Removing index on 'Aliquot', fields ['subject_identifier']
        db.delete_index('bhp_lab_core_aliquot', ['subject_identifier'])


    def backwards(self, orm):
        # Adding index on 'Aliquot', fields ['subject_identifier']
        db.create_index('bhp_lab_core_aliquot', ['subject_identifier'])

        # Adding index on 'Aliquot', fields ['receive_identifier']
        db.create_index('bhp_lab_core_aliquot', ['receive_identifier'])

        # Adding field 'Aliquot.import_datetime'
        db.add_column('bhp_lab_core_aliquot', 'import_datetime',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)

        # Deleting field 'Aliquot.primary_aliquot'
        db.delete_column('bhp_lab_core_aliquot', 'primary_aliquot_id')

        # Deleting field 'Aliquot.source_aliquot'
        db.delete_column('bhp_lab_core_aliquot', 'source_aliquot_id')

        # Deleting field 'Aliquot.is_packed'
        db.delete_column('bhp_lab_core_aliquot', 'is_packed')


        # Changing field 'Aliquot.subject_identifier'
        db.alter_column('bhp_lab_core_aliquot', 'subject_identifier', self.gf('django.db.models.fields.CharField')(max_length=25, null=True))
    ...
    models = {
        ...
        'lab_aliquot.aliquot': {
            ...
            'aliquot_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 5, 26, 0, 0)'}),
        ...
        'lab_receive.receive': {
            ...
            'receive_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 5, 26, 0, 0)', 'db_index': 'True'}),
